  ...
  <div class="col-lg-3">
	  <div class="card">
		...
		<div class="block-fluid table-sorting clearfix">
			...
			<?php
			$records = $po->getWebsiteFilteration();
			if(count($records)){
				$i=0;
				...
				<input class="form-check-input ml-0" data-label="<?php echo htmlspecialchars($item['store_name']);?>" name="<?php echo $field?>" id="<?php echo $field.'_'.$i?>" type="checkbox" value="<?php echo htmlspecialchars($item['po_store_id']);?>">
		...
		<div class="block-fluid table-sorting clearfix">
			...
			$field = 'po_is_closed';
			?>
			<label class="col-md-12 col-form-label"><h5 class="filterheading">Closed Status <i data-id="<?php echo $field;?>" class="filtercontroller pull-right fa fa-chevron-down"></i></h5></label>
			<div id="label_<?php echo $field;?>" class="col-md-12 col-form-label">
			
				<div class="form-check checkbox filtercheckbox">
				<input class="form-check-input ml-0" data-label="Status Open" name="<?php echo $field?>" id="<?php echo $field.'_1'?>" type="checkbox" value="0">
				<label class="form-check-label" for="<?php echo $field.'_1'?>">Status Open</label>
				</div>
				
				<div class="form-check checkbox filtercheckbox">
				<input class="form-check-input ml-0" data-label="Status Closed" name="<?php echo $field?>" id="<?php echo $field.'_2'?>" type="checkbox" value="1">
				<label class="form-check-label" for="<?php echo $field.'_2'?>">Status Closed</label>
				</div>
		...
		<div class="block-fluid table-sorting clearfix">
			...
			<div id="label_<?php echo $field;?>" class="col-md-12 col-form-label">
			<?php
			$records = $po->getCreatorFilteration();
			if(count($records)){
				$i=0;
				foreach($records as $item){
					$i++;
