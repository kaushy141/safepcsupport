<div class="row">
  <div class="col-sm-6">
    <div class="card">
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group">
              <label for="user_image">Select Policy File<sup>*</sup></label>
              <div class="input-group">
                                    <span class="input-group-addon" style="padding:0px" id="image_uploader"><i class="fa fa-file-pdf-o fa-lg"></i></span>
                                    <input class="form-control" id="policies_file" name="policy_file" style="padding-bottom: 4px; padding-top: 4px;" maxlength="100" value="" type="file" >
                                </div>
            </div>
          </div>
      ...
      <button type="button" onClick="filesUpload('policies_file');" class="btn btn-success submission_handler_btn"><i class="fa fa-check-circle fa-lg m-t-2"></i> <span id="btn_action_name"><?=$btnText?></span></button>
...
function removePolicies(id)
{
	...
	{
		var data={
			action	:	"company_resource/removepolicies",
			id		:	id			
		};
...
<div class="col-lg-12">
    ...
    <div class="card">
      <div class="card-header"> <i class="fa fa-align-justify"></i> Uploaded Policy List </div>
       <div class="block-fluid table-sorting clearfix">
        ...
        <table id="tbldatatable" class="table table-striped">
          ...
          <tbody>
          	<?php 
			$Policies = new Policies(0);
			echo $Policies->getRecords();
			?>
          </tbody>
        </table>
...
$("#tbldatatable").dataTable({
	...
	"columnDefs": [{ targets: [3], orderable: false },
					 { className: "hidden-xs hidden-md hidden-sm visible-lg", "targets": [ 1 ] },
					  { className: "word_break", "targets": [0] }
				]
	});
</script>