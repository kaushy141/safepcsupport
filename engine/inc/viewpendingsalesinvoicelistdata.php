  ...
  <div class="col-lg-3">
	  <div class="card">
		...
		<div class="block-fluid table-sorting clearfix">
			...
			<?php
			$records = $salesinvoice->getWebsiteFilteration(true);
			if(count($records)){
				$i=0;
		...
		<div class="block-fluid table-sorting clearfix">
			...
			<div id="label_<?php echo $field;?>" class="col-md-12 col-form-label">
			<?php
			$records = $salesinvoice->getStatusFilteration(true);
			if(count($records)){
				$i=0;
				foreach($records as $item){
					$i++;
		...
		<div class="block-fluid table-sorting clearfix">
			...
			<div id="label_<?php echo $field;?>" class="col-md-12 col-form-label">
			<?php
			$records = $salesinvoice->getCreatorFilteration(true);
			if(count($records)){
				$i=0;
				foreach($records as $item){
					$i++;
...
<?php }?>
  <div class="col-lg-<?php echo isAdmin() ? 9 : 12;?>">
    <div class="card">
      <div class="card-header"> <i class="fa fa-align-justify"></i>Pending Sales Invoice/Estimate List 
...
var data = {							
	...
	var postdata = {
			action	:	"viewpendingsalesinvoicelist",
			filter  :   formdata
		}
$(document).ready(function() {   
