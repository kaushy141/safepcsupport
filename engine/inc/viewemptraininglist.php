  ...
  <div class="col-lg-12">
    <div class="card">
      ...
      <?php if(isAdmin()):?>
            ...
            <a data-title="Complaint PDF Report" title="Generate PDF Report" href="javascript:newWindow('<?=DOC::EMPTRAININGLIST();?>');"><i class="icon-printer icons font-2xl d-block m-t-2"></i></a>
            <?php endif; ?>
        </div>
      </div>
...
function delEmpTraining(training_id){
	if(training_id != 0)
	{
		var data={
					action	:	'employee/delemptraining',
