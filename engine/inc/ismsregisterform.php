<div class="row">
  <div class="col-sm-6">
    <div class="card">
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="form-group">
              <label for="isms_file">Select isms File<sup>*</sup></label>
              <div class="input-group">
                                    <span class="input-group-addon" style="padding:0px" id="image_uploader"><i class="fa fa-file-pdf-o fa-lg"></i></span>
                                    <input class="form-control" id="isms_file" name="isms_file" style="padding-bottom: 4px; padding-top: 4px;" maxlength="100" value="" type="file" >
                                </div>
            </div>
          </div>
      ...
      <button type="button" onClick="filesUpload('isms_file');" class="btn btn-success submission_handler_btn"><i class="fa fa-check-circle fa-lg m-t-2"></i> <span id="btn_action_name"><?=$btnText?></span></button>
...
<div class="col-lg-12">
    ...
    <div class="card">
      <div class="card-header"> <i class="fa fa-align-justify"></i> Uploaded isms Register List </div>
