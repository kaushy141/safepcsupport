<div class="row">
  ...
  <div class="col-lg-12">
    <div class="card">
      <div class="card-header"> <i class="fa fa-align-justify"></i> Drop Off List 
      <div class="card-actions">
      <?php if(isAdmin()):?>
            <a data-title="Add New Complaint" class="redirect" title="Add New Collection/Drop Off" href="<?php echo $app->siteUrl("addcollection");?>"><i class="icon-star icons font-2xl d-block m-t-2"></i></a>
...
$(document).ready(function() {
    $('#tblSortable').DataTable( {
		...
		columnDefs: [{ targets: [6,7], orderable: false },
					 { className: "hidden-xs hidden-md hidden-sm visible-lg", "targets": [ 3,4,5,6 ] },
