...
<?php 
$navbarBgColors = array("4a235a", "154360", "641e16", "0b5345", "1b2631", "263238");
...
var userName = '<?php echo getUserType() == 'E' ? ($_SESSION['user_fname']. ' '.$_SESSION['user_lname']) : ($_SESSION['customer_fname']. ' '.$_SESSION['customer_lname'])?>';
var userImage = '<?=getResizeImage(getUserType() == 'E' ? $_SESSION['user_image'] : $_SESSION['customer_image'],50)?>';
var userType = '<?php echo getUserType();?>';
var app_filter_state = <?php echo isset($_SESSION['app_filter_state']) ? $_SESSION['app_filter_state']:0 ?>;
...
var logOffTimePassValue = <?php echo (isset($_COOKIE['LOGOFF']) && isset($_COOKIE['LOGOFFTIME'])) ? time() - $_COOKIE['LOGOFFTIME'] : 0;?>;
<!--=================================================================-->
...
var LIVE_CHAT_ENABLE_STATUS = <?php echo LIVE_CHAT_ENABLE_STATUS ? "true" : "false" ?>;
var CHASE_CUTOMER_NOTIFICATION = <?php echo (Employee::isUserServiceEnabled(getLoginId(), 'user_show_chase_customer') && getUserType() == 'E') ? 'true' : 'false' ?>;
...
background-repeat: no-repeat;">
	...
	<img class="img-avatar" src="<?=getResizeImage($_SESSION['user_image'],50)?>" >
	</div>
    <?php 
	if(date("H")>18) $wish = "Evening";
	elseif(date("H")>12) $wish = "Afternoon";
	else $wish = "Morning";
	?>
