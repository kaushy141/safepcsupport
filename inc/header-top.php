<header class="app-header navbar">
  ...
  <ul class="nav navbar-nav hidden-md-down">
    ...
    foreach ($topBarList as $nav) {
      echo "<li class=\"nav-item px-1\"><a class=\"nav-link redirect\" href=\"" .
        $app->siteUrl($nav["module_key"]) .
        "\"><i class=\"" .
        $nav["module_icon"] .
        "\"  ></i> " .
        $nav["module_topbar_name"] .
        "</a></li>";
    }
    ?>
  ...
  <ul class="nav navbar-nav ml-auto">
    ...
    <!--<li class="nav-item hidden-md-down"> <a id="locationTracking" class="nav-link redirect" href="<?php echo $app->siteUrl(
                                                                                                        "geotracking"
                                                                                                      ); ?>"><i class="icon-location-pin text-success"></i></a> </li>-->
    <li class="nav-item hidden-md-down"> <a id="lotanchortab" class="nav-link dropdown-toggle nav-link" data-toggle="dropdown" role="button" aria-haspopup="true" href="#"><i class="icon-handbag"></i><span class="badge badge-pill badge-success lot_product_count"></span></a>
      <div class="dropdown-menu dropdown-menu-right" style="position:absolute; top:35px; margin-top:0px;">
        ...
        <a class="dropdown-item viewcurrentlot redirect hide" href="<?php echo $app->siteUrl(
                                                                      "viewlotitems"
                                                                    ); ?>"><i class="fa fa-list"></i> View lot items</a>
    ...
    <li class="nav-item dropdown"> <a class="nav-link dropdown-toggle nav-link" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"> <img src="<?= getResizeImage(
                                                                                                                                                                                      $_SESSION["user_image"],
                                                                                                                                                                                      50
                                                                                                                                                                                    ) ?>" class="img-avatar" alt="<?= $_SESSION["user_fname"] ?>"></a>
      <div class="dropdown-menu dropdown-menu-right"> <a class="dropdown-item redirect" href="<?php echo $app->siteUrl(
                                                                                                "messages"
                                                                                              ); ?>"><i class="fa fa-envelope-o text-success"></i> Messages<span class="badge badge-success" id="complaint_global_log_count_dropdown"></span></a> <a class="dropdown-item redirect" href="<?php echo $app->siteUrl(
                                                                                                                                                                                                                                                                                            "profile"
                                                                                                                                                                                                                                                                                          ); ?>"><i class="fa fa-user text-primary"></i> Profile</a> <a class="logoffbtn dropdown-item" href="#"><i class="fa fa-sign-out text-warning"></i> Clock Out</a>
        <a class="dropdown-item systheme" data-theme="dark" href="#"><i class="fa fa-moon"></i> <?php echo $_SESSION["app_theme"] == "dark"
                                                                                                  ? ""
                                                                                                  : "Enable"; ?> Night mode</a>
        <a class="dropdown-item radiodatalistfilterstate" user-filter-state="<?php echo isset(
                                                                                $_SESSION["app_filter_state"]
                                                                              ) && $_SESSION["app_filter_state"] == 1
                                                                                ? 1
                                                                                : 0; ?>"><i class="fa <?php echo isset($_SESSION["app_filter_state"]) &&
                                                                                                        $_SESSION["app_filter_state"] == 1
                                                                                                        ? "text-success fa-toggle-on"
                                                                                                        : "fa-toggle-off"; ?>"></i> <span class="filter_state_text"><?php echo isset(
                                                                                              $_SESSION["app_filter_state"]
                                                                                            ) && $_SESSION["app_filter_state"] == 1
                                                                                              ? "Disable"
                                                                                              : "Enable"; ?> Filter State</span></a>
        ...
        <a class="dropdown-item redirect" href="<?php echo $app->siteUrl(
                                                  "logout"
                                                ); ?>"><i class="fa fa-power-off text-danger"></i> Logout</a>
        <!--<a class="dropdown-item" href="#"><i class="fa fa-locale"></i><div id="google_translate_element"></div></a>-->
      </div>
    </li>
  </ul>
</header>