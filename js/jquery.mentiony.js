    ...
    jQuery.fn.mentiony = function (method, options) {
        var defaults = {
            ...
            templates:          {
                ...
                content:          '<div id="mentiony-content-[ID]" class="mentiony-content" spellcheck="false" contenteditable="true"></div>',
    ...
    var MentionsInput = function (settings) {
        ...
        function showDropDown() {
            ...
            popoverEle.css({
                ...
                left:    Math.min(0,curAbsPos.x - elmInputBoxContentAbsPosition.left)
            });
        }
