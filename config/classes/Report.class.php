...
class Report extends PHPJasperXML{
	...
	public function __Construct($title="", $printSitename=false){
		...
		$this->copyright	=	"Copyright © ".date('Y')." E World UK Group";
		$this->poweredlink	=	"Powered By Tecknosoft";
	...
	public function addCopyRight($label = "E World UK Group"){
		$this->copyright	=	"Copyright © ".date('Y')." {$label}";
	}
