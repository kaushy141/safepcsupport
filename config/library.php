...
function drawCollectionProcedure($id)
{
  ...
  <li role=\"presentation nav-item nav-link\" class=\"text-center " . (($action == "collectionnearbycustomer" ? "active" : "")) . "\"><a class=\"redirect\" href=\"" . $app->basePath("collectionnearbycustomer/$id") . "\"><i class=\"fa fa-map-pin\"></i> <span class=\"hidden-xs\">Near By</span></a></li>
</div></nav >";
}
